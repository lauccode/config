...
;; Allow automatic evaluation of Emacs Lisp code blocks in Org-mode
;; (setq org-confirm-babel-evaluate nil)

Evaluate the Org file: When you make changes to your init.org file
you can evaluate the entire buffer by pressing
C-c C-v C-b (or M-x org-babel-execute-buffer).
This will execute all the Emacs Lisp code blocks in the file.
