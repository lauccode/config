...
before packages are loaded."
  ...
  ;;               '((shell :variables shell-default-vterm-shell "/bin/bash")))
  (setq-default dotspacemacs-configuration-layers
                '((shell :variables shell-default-shell 'vshell)))
  (setq-default dotspacemacs-configuration-layers
                '((shell :variables shell-protect-eshell-prompt nil)))

  ;; (setq-default dotspacemacs-themes '(spacemacs-light dracula))
